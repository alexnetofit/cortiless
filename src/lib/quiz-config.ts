...
export const QUIZ_STEPS: QuizStep[] = [
  ...
  // Step 9: Target zones
  {
    ...
    options: [
      { id: 'arms', label: 'Arms', image: '/images/zone-arms.svg' },
      { id: 'stomach', label: 'Stomach', image: '/images/zone-stomach.svg' },
      { id: 'back', label: 'Back', image: '/images/zone-back.svg' },
      { id: 'glutes', label: 'Glutes', image: '/images/zone-glutes.svg' },
      { id: 'legs', label: 'Legs', image: '/images/zone-legs.svg' },
      { id: 'hips', label: 'Hips', image: '/images/zone-hips.svg' },
      { id: 'whole-body', label: 'Whole body', image: '/images/zone-whole.svg' },
    ],
  },
